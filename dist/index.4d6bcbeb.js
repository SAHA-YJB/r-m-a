...
class App extends (0, _saha.Component) {
    render() {
...
},{"./core/SAHA":"OS5mO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./components/TheHeader":"3Cyq4","./components/TheFooter":"b3x3c"}],"OS5mO":[function(require,module,exports) {
///// Component /////
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.defineInteropFlag(exports);
var _saha = require("../core/SAHA");
class TheHeader extends (0, _saha.Component) {
    constructor(){
        super({
            tagName: "header",
            state: {
...
class TheFooter extends (0, _saha.Component) {
    constructor(){
        super({
            tagName: "footer"
        });
...
parcelHelpers.defineInteropFlag(exports);
var _saha = require("../core/SAHA");
exports.default = new (0, _saha.Store)({
    photo: "https://cdn.pixabay.com/photo/2015/04/23/17/41/javascript-736400_1280.png",
    name: "SAHA / YJB",
    email: "pkowork123@gmail.com",
    blog: "https://s-aha.tistory.com/",
    github: "https://github.com/SAHA-YJB",
    repository: "https://github.com/SAHA-YJB?tab=repositories"
});

},{"../core/SAHA":"OS5mO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3L9mC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _saha = require("../core/SAHA");
...
exports.default = (0, _saha.createRouter)([
    {
        path: "#/",
...
},{"../core/SAHA":"OS5mO","./Home":"0JSNG","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./Movie":"1LTyN","./About":"gdB30","./NotFound":"4fDiL"}],"0JSNG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _saha = require("../core/SAHA");
...
class Home extends (0, _saha.Component) {
    render() {
...
},{"../core/SAHA":"OS5mO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../components/Headline":"gaVgo","../components/Search":"jqPPz","../components/MovieList":"8UDl3","../components/MovieListMore":"3ZUar"}],"gaVgo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _saha = require("../core/SAHA");
class Headline extends (0, _saha.Component) {
    render() {
...
},{"../core/SAHA":"OS5mO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jqPPz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _saha = require("../core/SAHA");
var _movie = require("../store/movie");
var _movieDefault = parcelHelpers.interopDefault(_movie);
class Search extends (0, _saha.Component) {
    render() {
...
},{"../core/SAHA":"OS5mO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../store/movie":"kq1bo"}],"kq1bo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../core/SAHA":"OS5mO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8UDl3":[function(require,module,exports) {
//영화 목록 컴포넌트
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _saha = require("../core/SAHA");
...
class MovieList extends (0, _saha.Component) {
    constructor(){
        super();
...
parcelHelpers.defineInteropFlag(exports);
var _saha = require("../core/SAHA");
class MovieItem extends (0, _saha.Component) {
    constructor(props){
        super({
            props,
            tagName: "a"
...
},{"../core/SAHA":"OS5mO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3ZUar":[function(require,module,exports) {
// 더보기 컴포넌트
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _saha = require("../core/SAHA");
var _movie = require("../store/movie");
var _movieDefault = parcelHelpers.interopDefault(_movie);
class MovieListMore extends (0, _saha.Component) {
    constructor(){
        super({
            tagName: "button"
        });
...
},{"../core/SAHA":"OS5mO","../store/movie":"kq1bo","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1LTyN":[function(require,module,exports) {
//영화 상세정보 페이지 컴포넌트
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _saha = require("../core/SAHA");
var _movie = require("../store/movie");
var _movieDefault = parcelHelpers.interopDefault(_movie);
class Movie extends (0, _saha.Component) {
    async render() {
...
},{"../core/SAHA":"OS5mO","../store/movie":"kq1bo","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gdB30":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _saha = require("../core/SAHA");
var _about = require("../store/about");
var _aboutDefault = parcelHelpers.interopDefault(_about);
class About extends (0, _saha.Component) {
    render() {
...
},{"../core/SAHA":"OS5mO","../store/about":"4RAJO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4fDiL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _saha = require("../core/SAHA");
class NotFound extends (0, _saha.Component) {
    render() {
...
},{"../core/SAHA":"OS5mO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["e11Rl","gLLPy"], "gLLPy", "parcelRequirebdd2")
